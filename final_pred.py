...
class Application:
    ...
    def __init__(self):
        ...
        self.speak.config(text="Meme it", font=("Courier", 20), wraplength=100, command=self.speak_fun)
    ...
    def speak_fun(self):
        # Ensure self.str is properly initialized and not empty
        self.final_string = self.str
        if not self.final_string:
            print("Input string is empty!")
            return
    
        response_data = self.send_to_flux(self.final_string)
